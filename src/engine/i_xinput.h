...
typedef struct {
	...
	bool        connected;                  // is controller connected?
	bool        available;                  // is api available? can be disabled with -noxinput
...
void        I_XInputVibrate(bool leftside, byte amount, int windDown);
