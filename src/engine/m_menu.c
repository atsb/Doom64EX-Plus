...
bool            allowmenu = true;                   // can menu be accessed?
bool            menuactive = false;
bool            mainmenuactive = false;
bool            allowclearmenu = true;              // can user hit escape to clear menu?
...
static bool M_CursorHighlightItem(menu_t* menu) {
	float scrnx;
	float scrny;
	float mx;
	float my;
