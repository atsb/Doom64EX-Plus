...
bool R_GenerateSwitchPlane(seg_t* line, vtx_t* v) {
	fixed_t     bottom = 0;
	fixed_t     top = 0;
	int         offset = 0;
	fixed_t     cenx;
...
static bool R_GenerateLowerSegPlane(seg_t* line, vtx_t* v) {
	line_t* linedef;
	side_t* sidedef;
	rfloat      top;
	rfloat      bottom;
...
static bool R_GenerateUpperSegPlane(seg_t* line, vtx_t* v) {
	line_t* linedef;
	side_t* sidedef;
	rfloat      top;
	rfloat      bottom;
...
static bool R_GenerateMiddleSegPlane(seg_t* line, vtx_t* v) {
	line_t* linedef;
	side_t* sidedef;
	rfloat      top;
	rfloat      bottom;
