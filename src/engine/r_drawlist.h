...
bool DL_ProcessWalls(vtxlist_t* vl, int* drawcount);
bool DL_ProcessLeafs(vtxlist_t* vl, int* drawcount);
bool DL_ProcessSprites(vtxlist_t* vl, int* drawcount);
