...
#define SDL_LOADSO_DUMMY  1 // No native DLL loader in the XDK :(
...
// Rather than use Haptic I think 
// XBOX_JoystickRumble() in SDL_Joystick.c 
// should be implemented
#define SDL_HAPTIC_DUMMY  1

/* Enable system power support */
#define SDL_POWER_XBOX  1
