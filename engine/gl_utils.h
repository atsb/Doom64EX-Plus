...
#define OGL_CONTEXT_FLOATBUFFERS GLFW_CONTEXT_RELEASE_BEHAVIOR
...
#define OGL_CONTEXT_PROFILE_MASK GLFW_OPENGL_COMPAT_PROFILE  
#define OGL_CONTEXT_PROFILE_CORE GLFW_OPENGL_CORE_PROFILE
#define OGL_DEFS	\
GLFWwindow *Window	\
...
#define OGL_ACCELERATED SDL_GL_ACCELERATED_VISUAL
#define OGL_RETAINED SDL_GL_RETAINED_BACKING
#define OGL_MAJOR_VERSION GL_MAJOR_VERSION
#define OGL_MINOR_VERSION GL_MINOR_VERSION
#define OGL_CONTEXT SDL_GL_CONTEXT_EGL
#define OGL_CONTEXT_FLAGS GL_CONTEXT_FLAGS
#define OGL_CONTEXT_PROFILE GL_CONTEXT_PROFILE_MASK
#define OGL_CURRENT_CONTEXT SDL_GL_SHARE_WITH_CURRENT_CONTEXT
...
#define OGL_CONTEXT_RESET GL_RESET_NOTIFICATION_STRATEGY
#define OGL_CONTEXT_NO_ERROR GL_NO_ERROR
#define OGL_CONTEXT_FLOATBUFFERS SDL_GL_FLOATBUFFERS
#define OGL_DOUBLE_BUFFER GL_DOUBLEBUFFER
#define OGL_CONTEXT_PROFILE_MASK GL_CONTEXT_PROFILE_MASK
#define OGL_CONTEXT_PROFILE_CORE GL_CONTEXT_CORE_PROFILE_BIT
#define OGL_WINDOW_HINT(attr, value) SDL_GL_SetAttribute(attr, value)
#define OGL_DESTROY_WINDOW(context) SDL_GL_DeleteContext(context)
#define OGL_DEFS    \
SDL_GLContext   Window
